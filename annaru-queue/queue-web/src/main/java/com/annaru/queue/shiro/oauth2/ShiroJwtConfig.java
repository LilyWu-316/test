...
import com.annaru.queue.shiro.cache.RedisCacheManager;
import com.annaru.queue.shiro.cache.RedisSessionDAO;
 ...
 */
@Configuration
@ConditionalOnProperty(value = "annaru.queue.type", havingValue = "jwt", matchIfMissing = false)
public class ShiroJwtConfig {

    @Value("${annaru.shiro.cookie}")
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/queue/pickup/**", "anon");// 存件取件接口
        filterChainDefinitionMap.put("/queue/auth", "anon");
