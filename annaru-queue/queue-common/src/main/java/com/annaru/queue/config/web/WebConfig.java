package com.annaru.queue.config.web;


import com.annaru.queue.csrf.CsrfInterceptor;
import com.annaru.queue.interceptor.FileUploadTypeInterceptor;
...
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/upload/**").addResourceLocations("file:C:/Project/annaru_queue/upload_file/");
